...
export default function FloatingChatbot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end pointer-events-none">
      ...
      >
        <div className="glass-card-premium !bg-[#12121A]/85 relative overflow-hidden w-[350px] sm:w-[400px] h-[500px] max-h-[80vh] flex flex-col shadow-2xl rounded-2xl border border-white/10">
          <div className="bg-noise opacity-30" />
          
          {/* Header */}
          <div className="relative z-10 flex items-center justify-between p-4 border-b border-white/10 bg-black/40 backdrop-blur-md">
